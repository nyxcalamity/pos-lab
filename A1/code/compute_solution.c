...
int compute_solution(const int max_iters, int nintci, int nintcf, int nextcf, int** lcc, double* bp,
    ...
    double *resvec = (double *) calloc( (nintcf + 1), sizeof(double) );
    ...
    double *direc1 = (double *) calloc( (nextcf + 1), sizeof(double) );
    double *direc2 = (double *) calloc( (nextcf + 1), sizeof(double) );
    double *adxor1 = (double *) calloc( (nintcf + 1), sizeof(double) );
    double *adxor2 = (double *) calloc( (nintcf + 1), sizeof(double) );
    double *dxor1 = (double *) calloc( (nintcf + 1), sizeof(double) );
    double *dxor2 = (double *) calloc( (nintcf + 1), sizeof(double) );
